		...
		<Layout>
			<SignInContainer>
				<SignInForm>
					...
					<Button varient='black' rounded='sm' size='full' padding='lg' onClick={handleSignIn}>
						<BoldLgText>
							<span>Sign In</span>
						</BoldLgText>
					</Button>
					...
					<SignUpButton varient='white' border='black' rounded='sm' size='full' padding='lg' onClick={handleSignUp}>
